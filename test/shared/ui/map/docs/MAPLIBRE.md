...
| `true` | `TextureView` dikomposit Flutter | Kos render lebih tinggi, tapi sentuhan ikut laluan input normal. |
...
Kita set `true`. Itu **tekaan berasas, bukan ukuran**: mana satu lebih laju
bergantung GPU peranti. Kalau gesture terasa clunky, flip ia dahulu sebelum
apa-apa lain - ia satu-satunya knob yang menyentuh perkara itu.
